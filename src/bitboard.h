...
extern uint64_t ranks_in_front_bb[num_sides][num_ranks];
extern uint64_t in_front_bb[num_sides][num_squares];
extern uint64_t passed_pawn_mask[num_sides][num_squares];
extern uint64_t pawn_attack_span[num_sides][num_squares];
extern uint64_t pawnattack[num_sides][num_squares];
extern uint64_t empty_attack[num_piecetypes][num_squares];
extern uint64_t king_zone[num_squares];
extern uint64_t connection_bb[num_squares][num_squares];
extern int8_t square_distance[num_squares][num_squares];
extern uint64_t rook_mask[num_squares];
extern uint64_t bishop_mask[num_squares];
