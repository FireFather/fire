// evaluate.cpp
// Contains functions to evaluate chess positions using NNUE (efficiently updatable neural network)
// Requires: main.h, nnue.h, position.h
...
int eval_nnue(const position& pos) {
    ...
    for (uint8_t i = 0; i < 64; i++) {
        ...
        else if (pc == 2) { // white queen
            pieces[index] = 6;
            squares[index] = i;
            index++;
        } else if (pc == 3) { // white rook
            pieces[index] = 5;
            squares[index] = i;
            index++;
        } else if (pc == 4) { // white bishop
            pieces[index] = 4;
            squares[index] = i;
            index++;
        } else if (pc == 5) { // white knight
            pieces[index] = 3;
            squares[index] = i;
            index++;
        } else if (pc == 6) { // white pawn
            pieces[index] = 2;
            squares[index] = i;
            index++;
        } else if (pc == 10) { // black queen
            pieces[index] = 12;
            squares[index] = i;
            index++;
        } else if (pc == 11) { // black rook
            pieces[index] = 11;
            squares[index] = i;
            index++;
        } else if (pc == 12) { // black bishop
            pieces[index] = 10;
            squares[index] = i;
            index++;
        } else if (pc == 13) { // black knight
            pieces[index] = 9;
            squares[index] = i;
            index++;
        } else if (pc == 14) { // black pawn
            pieces[index] = 8;
            squares[index] = i;
            index++;
        }
